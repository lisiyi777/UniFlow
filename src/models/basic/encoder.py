...
class DynamicPillarFeatureNet(PillarFeatureNet):
    ...
    def map_voxel_center_to_point(self, pts_coors, voxel_mean, voxel_coors):
        ...
        canvas_y = int(round((self.point_cloud_range[4] - self.point_cloud_range[1]) / self.vy))
        canvas_x = int(round((self.point_cloud_range[3] - self.point_cloud_range[0]) / self.vx))
